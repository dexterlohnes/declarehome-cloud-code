 ...
 */ 
exports.addUserToGroupsMembersRelation = function addUserToGroupsMembersRelation(user, group) {
 ...
 * @return A Parse.Promise object once the function is done
 */ 
exports.addUserToGroupsAdminsRelation = function addUserToGroupsAdminsRelation(user, group) {
 ...
 * @return A Parse.Promise object once the function is done
 */ 
exports.removeUserFromMembersRelation = function removeUserFromMembersRelation(user, group) {
	//1 Get a handle on the group's members relation
	var membersRel = group.get("membersRole").getUsers();
 ...
 * @return A Parse.Promise object once the function is done
 */ 
exports.removeUserFromAdminsRelation = function removeUserFromAdminsRelation(user, group) {
	//1 Get a handle on the group's admins relation
	var adminsRel = group.get("adminsRole").getUsers();
 ...
 *	Adds the user to the Parse.Role which has admin or member (or other?) permissions for the group in question
 */
exports.RemoveUserFromGroupRole = function RemoveUserFromGroupRole(group, user, roleName) {
